...
public class OrderBook {
    ...
    public double findMatchingPrice(ArrayList<Order> buyOrdersForSymbol,
        ...
        // System.out.println("=========");
        // for (Order o : buyOrdersForSymbol) {
        // o.printOrder();
        // }
        // for (Order o : sellOrdersForSymbol) {
        // o.printOrder();
        // }
        // System.out.println("=========");
        ...
        for (CumulativeOrder cumulativeSellOrder : cumulativeSellOrders
            ...
            for (CumulativeOrder cumulativeBuyOrder : cumulativeBuyOrders
                ...
                if (newSize >= orderSize) {
                    // System.out.println("Old size: " + orderSize
                    // + ", new size: " + newSize);
                    // System.out.println("Old price: " + orderPrice
                    // + ", new price: " + newPrice);
     ...
     * 
     * @param unboughtOrders
     * @param unsoldOrders
     * @param cumulativeBuyOrder
     * @return
     */
    ...
    private void validateOrders(HashSet<Order> unboughtOrders,
        ...
        // TODO: Add price parameter, and only modify getTotalSize to include it
